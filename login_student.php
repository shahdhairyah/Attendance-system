...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($email) || empty($password)) {
        ...
        $stmt = $conn->prepare("SELECT id, name, roll_no, email, password, department FROM students WHERE email = ?");
...
<head>
    ...
    <title>Student Login - Digital Attendance System</title>
                    ...
                    <div class="login-card">
                        ...
                        <div class="mt-4 p-3 bg-light rounded">
                            ...
                            <small class="text-muted">
                                Email: john.smith@student.edu<br>
                                Password: password
                            </small>
                        </div>
                    </div>
