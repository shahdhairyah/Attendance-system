...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($email) || empty($password)) {
        ...
        $stmt = $conn->prepare("SELECT id, name, email, password, department FROM faculty WHERE email = ?");
...
<head>
    ...
    <title>Faculty Login - AttendanceHub</title>
        ...
        * {
        ...
        body::before {
            ...
            background: 
                ...
                radial-gradient(circle at 40% 40%, rgba(150, 201, 61, 0.2) 0%, transparent 50%);
        ...
        @keyframes iconPulse {
            0%, 100% { transform: scale(1); box-shadow: 0 20px 40px rgba(17, 153, 142, 0.4); }
            50% { transform: scale(1.05); box-shadow: 0 25px 50px rgba(17, 153, 142, 0.6); }
        }
        ...
        .btn-login {
            ...
            box-shadow: 
                0 12px 35px rgba(86, 171, 47, 0.4),
                inset 0 2px 0 rgba(255, 255, 255, 0.3);
            position: relative;
            overflow: hidden;
            color: white;
        ...
        .btn-login:hover {
            ...
            box-shadow: 
                0 20px 50px rgba(86, 171, 47, 0.6),
    ...
    <div class="login-wrapper">
        <div class="login-container">
            ...
            <div class="brand-section">
                ...
                <h1 class="brand-title">Faculty Portal</h1>
                <p class="brand-subtitle">Access your teaching dashboard</p>
            </div>
            ...
            <form method="POST" action="" id="loginForm" novalidate>
                ...
                <button type="submit" class="btn btn-login w-100 mb-4" id="loginBtn">
                    <span class="btn-text">
                        <i class="fas fa-sign-in-alt me-2"></i>Access Faculty Portal
                    </span>
                </button>
            </form>
            ...
            <div class="demo-credentials">
                ...
                <div class="demo-info">
                    <div class="mb-2">
                        <strong>Email:</strong> sarah.johnson@college.edu
                    </div>
                    <div>
